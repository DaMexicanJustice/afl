...
(function(window) {
    ...
    var BombManager = new Class({
        ...
        update: function(tdelta) {
            ...
            if (this.nextBomb < 0) {
                ...
                this.nextBomb = -1;
                this.game.ui.showMessage("Bombe er klar! <br />(Tryk F for at jorde VintageGames til grunden!)");
            }
        },
        blow: function() {
    ...
    var SessionManager = new Class({
        ...
        weHaveWon: function() {
            this.isPlaying = false;
            this.game.ui.showMessage("Intet tilbage end dette tomrum...");
            this.game.ui.showMessage("For at fortryde tilintetgørelsen af VintageGames.dk tryk F5.");
